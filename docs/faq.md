...
**Q: Is it production-ready?** A: It runs the admin of a commercial product with a 14-export custom build (22 KB gzip) and passes 1 085 assertions in headless Chrome, Firefox and WebKit on every push. The ten core names are stable through 0.x; five older aliases were removed in 0.7.1 and nothing is marked `@deprecated` any more.
